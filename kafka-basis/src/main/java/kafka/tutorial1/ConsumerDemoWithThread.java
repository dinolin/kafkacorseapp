...
public class ConsumerDemoWithThread {
    ...
    private void run() {
        ...
        Runnable myConsumerRunable= new ConsumerRunable(
                bootstrapServers,
                groupID,
                topic,
                latch
        ...
        Runtime.getRuntime().addShutdownHook(new Thread( ()->{
            logger.info("Cautht shutdown hook");
    ...
    public class ConsumerRunable implements Runnable{
        ...
        public ConsumerRunable( String bootstrapServers, String groupID, String topic, CountDownLatch latch){
            this.latch = latch;
